    ...
    for rect in rects:
        ...
        if ear < EYE_AR_THRESH:
            ...
            if COUNTER >= EYE_AR_CONSEC_FRAMES:
                ...
                playsound('C:\\Users\dell\Downloads\mixkit-facility-alarm-908.wav')
        ...
        cv2.putText(frame, "MAR: {:.2f}".format(mouEAR), (480, 60),
            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        cv2.putText(frame,"Drowsiness Detection",(370,470),cv2.FONT_HERSHEY_COMPLEX,0.6,(153,51,102),1)
